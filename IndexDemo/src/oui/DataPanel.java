...
public class DataPanel extends JPanel implements ActionListener {
	...
	private void initComponents() {
		...
		//datapanel observing button
		//observer will call observed and will tell him to register him for a particular event
		//this should be actionListener type
	 ...
	 //plugs created by actionlistener 
	//fill in the blanks to be filled
	@Override
